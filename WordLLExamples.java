...
public class WordLLExamples {
	...
	public static void main(String[] args) {
		...
		Scanner game_mode = new Scanner(System.in, "UTF-8");
		readMysteryWords("words");
		System.out.println("Welcome! Please type in 'Wordle' or 'Euchre' to play the corresponding game.");
		switch(game_mode.nextLine()){
			case "Wordle":
				playEnglish();
				break;
			case "Euchre":
